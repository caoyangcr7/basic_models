...
class YoloV1(object):
    ...
    def _fc_layer(self,x, id, num_out, activation=None):
        ...
        if self.verbose:
            print("    Layer %d: type=Fc, num_out=%d, output_shape=%s" % (id, num_out, str(output.get_shape())))
...
if __name__ == "__main__":
    yolo_net = YoloV1("./weights/YOLO_small.ckpt")
